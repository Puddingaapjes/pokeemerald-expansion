...
#define NUM_ABILITY_SLOTS (NUM_FIXED_ABILITY_SLOTS + NUM_SECOND_ABILITY_SLOTS + NUM_HIDDEN_ABILITY_SLOTS)
#define NUM_SECOND_ABILITY_SLOTS 1
#define NUM_FIXED_ABILITY_SLOTS 1
#define NUM_NORMAL_ABILITY_SLOTS (NUM_SECOND_ABILITY_SLOTS + NUM_FIXED_ABILITY_SLOTS)
