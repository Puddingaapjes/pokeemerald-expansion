...
static void DrawFollowerSprite(struct PokemonSpriteVisualizer *data)
{
    ...
    const struct ObjectEventGraphicsInfo *graphicsInfo = SpeciesToGraphicsInfo(species, data->isShiny, data->isFemale, FALSE);
...
void CB2_Pokemon_Sprite_Visualizer(void)
{
    ...
    case 3:
        ...
        //Icon Sprite
        data->iconspriteId = CreateMonIcon2(species, SpriteCB_MonIcon, VISUALIZER_ICON_X, VISUALIZER_ICON_Y, 4, data->isShiny, (data->isFemale ? FEMALE_PERSONALITY : MALE_PERSONALITY), FALSE);
